...
async function main() {
    ...
    const flashSwapFactory = await hardhat_1.ethers.getContractFactory("FlashSwap");
    const flashSwap = await flashSwapFactory.deploy(_uniswapV3Router, _aavePool, _uniswapV3Factory, _wethAddress, _initialOwner);
