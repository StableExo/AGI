...
exports.CoinbaseExecutor = void 0;
...
class CoinbaseExecutor {
    ...
    async makeSignedRequest(method, path, body = {}) {
        ...
        try {
            ...
            logger_service_1.default.error(`[CoinbaseExecutor] API Request FAILED for ${method} ${path}:`, error.response ? error.response.data : error.message);
            throw error;
        }
    }
    async placeOrder(action) {
        ...
        if (this.executionMode === 'DRY_RUN') {
            logger_service_1.default.info('[CoinbaseExecutor][DRY_RUN] Would place the following order:');
            logger_service_1.default.info(JSON.stringify(requestBody, null, 2));
            return {
                success: true,
            ...
            logger_service_1.default.info('[CoinbaseExecutor][LIVE] Placing real order...');
...
exports.CoinbaseExecutor = CoinbaseExecutor;
