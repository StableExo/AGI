...
exports.WalletConnectorService = void 0;
...
class WalletConnectorService {
    ...
    async initialize() {
        ...
        this.sdk = new wallet_sdk_1.CoinbaseWalletSDK({
            appName: APP_NAME,
            appLogoUrl: APP_LOGO_URL,
            darkMode: true,
        });
        const web3Provider = this.sdk.makeWeb3Provider(`https://mainnet.infura.io/v3/YOUR_INFURA_PROJECT_ID`, // Placeholder RPC URL
        DEFAULT_CHAIN_ID);
    ...
    async proposeERC20Transfer(proposal) {
        if (!this.provider || !this.userAddress) {
            throw new Error('Wallet not connected. Please initialize first.');
        }
        const signer = this.provider.getSigner();
        ...
        const contract = new ethers_1.ethers.Contract(proposal.contractAddress, erc20Abi, signer);
...
exports.WalletConnectorService = WalletConnectorService;
